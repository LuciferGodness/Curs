...
QT_MOC_LITERAL(5, 3), // "add"
QT_MOC_LITERAL(9, 0), // ""
QT_MOC_LITERAL(10, 1), // "b"
QT_MOC_LITERAL(12, 3), // "win"
QT_MOC_LITERAL(16, 7), // "buy_obj"
QT_MOC_LITERAL(24, 21) // "on_pushButton_clicked"

    },
    "shop\0add\0\0b\0win\0buy_obj\0on_pushButton_clicked"
};
...
void shop::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (shop::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&shop::add)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (shop::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&shop::win)) {
                *result = 1;
                return;
            }
        }
